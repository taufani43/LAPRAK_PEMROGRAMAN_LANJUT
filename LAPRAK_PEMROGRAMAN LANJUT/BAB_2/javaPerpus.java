...
public class javaPerpus {
    public static void main(String[] args) {
        ...
        b2.setPenulisbanyak(new String[]{"Dewi Kartika Sari", "Nurul Hasfi", "Hedi Pudjo Santosa", "Triyono Lukmantoro", "Narayana Mahendra Prastya", "Santi Isnaini", "Said Romadlan", "Sa’diyah El Adawiyah", "Suwarto", "Aminah Swarnawati",
        "AgungPrabowo", "Kurnia Arofah", "Sri Budi Lestari", "Edi Antoso","Mas'Amah"});
        b2.setPenerbitan("ASPIKOM 2015");
        b2.setBahasa("Indonesia");
        b2.setEdisi("Pertama");
        b2.setHalaman(178);
        b2.setSinopsis("Buku ini membahas bagaimana individu dapat mengembangkan keterampilan literasi media digital, termasuk bagaimana memahami dan menganalisis informasi digital, membangun identitas digital yang positif, dan memahami risiko dan keamanan online.");;
        b2.displayMessage();
        System.out.println("=====================================");
        ...
        b3.setEdisi("-");
        b3.setHalaman(800);
        b3.setSinopsis("Novel ini mengisahkan perjalanan Sophie Amundsen, seorang gadis remaja yang tiba-tiba menerima surat misterius.");
        b3.displayMessage();
        System.out.println("=====================================");
        ...
        b6.setEdisi("Pertama");
        b6.setHalaman(100);
        b6.setSinopsis("Buku ini membahas bagaimana hadis dituliskan dan dikumpulkan oleh para ahli hadis pada masa awal Islam.");
        b6.displayMessage();
        System.out.println("=====================================");
        ...
        b7.setEdisi("Pertama");
        b7.setHalaman(240);
        b7.setSinopsis("Buku yang membahas tentang adab dan kebiasaan Nabi Muhammad SAW dalam berkomunikasi dengan orang lain.");
        b7.displayMessage();
        System.out.println("=====================================");
        ...
        b8.setEdisi("Pertama");
        b8.setHalaman(116);
        b8.setSinopsis("Buku ini berisi kumpulan cerita tentang cinta, kasih sayang, keikhlasan, dan keteguhan iman dalam menghadapi cobaan hidup.");
        b8.displayMessage();
        System.out.println("=====================================");
        ...
        b9.setEdisi("Pertama");
        b9.setHalaman(121);
        b9.setSinopsis("Novel ini mengisahkan tentang kehidupan Essun, seorang ibu yang mencoba mencari putranya yang hilang setelah suaminya membunuh anak mereka yang lain dan pergi.");
        b9.displayMessage();
        System.out.println("=====================================");
        ...
        b11.setEdisi("-");
        b11.setHalaman(42);
        b11.setSinopsis("Buku ini membahas tentang nasionalisme di Indonesia, baik pada masa sekarang maupun di masa depan.");
        b11.displayMessage();
        System.out.println("=====================================");
        ...
        b13.setEdisi("-");
        b13.setHalaman(390);
        b13.setSinopsis("Novel ini mengisahkan tentang kisah keluarga dan aktivis politik Indonesia selama periode kekuasaan Orde Baru di Indonesia.");
        b13.displayMessage();
        System.out.println("=====================================");
        ...
        b14.setEdisi("-");
        b14.setHalaman(257);
        b14.setSinopsis("Novel ini mengisahkan tentang kisah dua orang yang terlibat dalam dendam dan cinta di sebuah desa di Indonesia.");
        b14.displayMessage();
        System.out.println("=====================================");
